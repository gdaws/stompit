...
Socket.prototype._end = function(){
    this._outputEnded = true;
    this._transportSocket.end();
    this.emit("finish");
};

Socket.prototype.isOutputEnded = function(){
    return this._outputEnded;
};

Socket.prototype.isInputEnded = function(){
