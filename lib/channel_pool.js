...
ChannelPool.prototype._addExcessTimeout = function() {
  ...
  var close = function() {
    self._freeChannels.shift().close();
    self._numChannels -= 1;
  };
...
ChannelPool.prototype.subscribe = function() {
  this._forwardCall(Channel.prototype.subscribe, arguments);
};

ChannelPool.prototype.begin = function() {
  this._forwardCall(Channel.prototype.begin, arguments);
};
