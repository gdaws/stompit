...
FrameOutputStream.prototype.frame = function(command, headers, streamOptions) {
  ...
  var frame = new OutgoingFrame(this, command, headers, streamOptions);
  
  return this._queueFrame(frame);
};

FrameOutputStream.prototype.heartbeat = function() {
...
OutgoingFrame.prototype.end = function(chunk, encoding, cb) {
...
OutgoingFrame.prototype._endFrame = function(cb) {
...
OutgoingFrame.prototype._writeHeaderAndBody = function(chunk, encoding, cb) {
  
  this._writeHeader();
  this._writeBody(chunk, encoding, cb);
};

OutgoingFrame.prototype._writeHeader = function(cb) {
...
OutgoingFrame.prototype._writeBody = function(chunk, encoding, cb) {
...
OutgoingFrame.prototype._pushWriteRequest = function(chunk, encoding, cb) {
