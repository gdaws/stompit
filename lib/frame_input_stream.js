...
FrameInputStream.prototype.readFrame = function(callback, errorCallback){
    ...
    var frame = new IncomingFrameClass(this, callback, errorCallback);
...
function emptyFrameQueue(){
    ...
    if(this._frame){
        ...
        if(this._frame.errorCallback){
            this._frame.errorCallback(this._frame.readingFrame ? this._frame : null);
        }
...
function readBody(source){
    ...
    while((chunk = source.read()) !== null && pushable){
